        ...
        <div class="content">
            ...
            <div class="productCollapse">
                ...
                <div class="collapse homeProductCollapse" id="collapseExample{{$brand->id}}">
                    ...
                    @if($brand->id == $brand->product->idbrand)
                        <div class="card card-body productHome col-sm-3">
                            <div class="homeProductTitle">{{$brand->product->name}}</div>
                            <div class="homeProductPhoto"><img src="{{$brand->product->picture}}" width="100%"></div>
                            <div class="row">
